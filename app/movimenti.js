...
router.post("", async (req, res) => {
  ...
  if (
    ...
    return res.status(400).send("Tutti i campi devono essere compilati.");
  }

  // Controlla che l'importo sia un numero
  const importo = parseFloat(req.body.importo);
  if (isNaN(importo)) {
    return res.status(400).send("L'importo deve essere un numero valido.");
  }
