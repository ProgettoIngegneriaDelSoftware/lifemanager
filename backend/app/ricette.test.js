...
describe("test ricette", () => {
    ...
    test("DELETE /api/v1/ricette/ricettanonesistente Cancellazione di una ricetta da parte di un utente autenticato, senza che la ricetta venga prima inserita nel database", () => {
        // Esecuzione del test
        return request(app)
