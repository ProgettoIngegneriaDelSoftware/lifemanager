...
\begin{center}
 \fbox{ \includegraphics[width=3cm]{Registrazione.png}}
\end{center}
...
\begin{center}
  \fbox{\includegraphics[width=3cm]{Login.png}}
\end{center}
...
\begin{center}
  \fbox{\includegraphics[width=3cm]{Home Page.png}}
  \fbox{\includegraphics[width=3cm]{Impostazioni.png}}
  \fbox{\includegraphics[width=3cm]{Account.png}}
\end{center}
...
\begin{center}
  \fbox{\includegraphics[width=3cm]{Gestione Budget.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Movimento.png}}
  \fbox{\includegraphics[width=3cm]{Elenco Entrate.png}}
  \fbox{\includegraphics[width=3cm]{Elenco Uscite.png}}
  \fbox{\includegraphics[width=3cm]{Elenco Bollette.png}}
  \fbox{\includegraphics[width=3cm]{espese.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Bolletta.png}}
  \fbox{\includegraphics[width=3cm]{aspesa.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Categoria.png} }
\end{center}
...
\begin{center}
  \fbox{\includegraphics[width=3cm]{Eventi.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Evento.png}}
\end{center}
...
\begin{center}
  \fbox{\includegraphics[width=3cm]{Carte Fedeltà.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Carta Fedeltà.png}}
  \fbox{\includegraphics[width=3cm]{Esempio Carta.png}}
\end{center}
...
\begin{center}
  \fbox{\includegraphics[width=3cm]{Mappa.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Luogo.png}}
\end{center}
...
\begin{center}
  \fbox{\includegraphics[width=3cm]{Ricette.png}}
  \fbox{\includegraphics[width=3cm]{Nuova Ricetta.png}}
  \fbox{\includegraphics[width=3cm]{Esempio Ricetta.png}}
\end{center}
...
\begin{center}
  \fbox{\includegraphics[width=3cm]{ListeP.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Lista.png}}
  \fbox{\includegraphics[width=3cm]{Lista della spesa.png}}
  \fbox{\includegraphics[width=3cm]{Cose Da Fare.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Articolo.png}}
  \fbox{\includegraphics[width=3cm]{Aggiungi Attività.png}}
\end{center}
...
\begin{center}
  \includegraphics[width=10cm]{UCDloginregistrazione.jpeg}
...
\begin{center}
  \includegraphics[width=10cm]{UCDHomePage.jpeg}
...
\begin{center}
  \includegraphics[width=10cm]{UCDbudget.jpeg}
...
\begin{center}
  \includegraphics[width=10cm]{UCDliste.jpeg}
...
\begin{center}
  \includegraphics[width=10cm]{UCDeventi.jpeg}
...
\begin{center}
  \includegraphics[width=10cm]{UCDricette.jpeg}
...
\begin{center}
  \includegraphics[width=10cm]{UCDluoghi.jpeg}
...
\begin{center}
  \includegraphics[width=10cm]{UCDcartefedeltà.jpeg}
